...
- 親と全九役の子を GPT-6 Astra に統一。D1 は Low/Medium/High、D2 は Medium/High、D3 は High/xhigh、D4 は xhigh/Max を使用。
...
- Windows/Linux validator を九役の model、effort、sandbox と Astra 向けポリシーの検査へ更新。
